...
namespace Laborator
{
	...
	public:
		...
		void MoveForward(float distance)
		{
			...
			// movement will keep the CameraTema at the same height always
			...
			// Translate the CameraTema using the DIR vector computed from forward
		}

		void TranslateForward(float distance)
		{
			// TODO : Translate the CameraTema using the "forward" vector
			position += glm::normalize(forward) * distance;
		}

		void TranslateUpword(float distance)
		{
			// TODO : Translate the CameraTema using the up vector
		...
		{
			// TODO
			// Translate the CameraTema using the "right" vector
			// Usually translation using CameraTema "right' is not very useful because if the CameraTema is rotated around the "forward" vector 
			// translation over the right direction will have an undesired effect; the CameraTema will get closer or farther from the ground
		...
		{
			// TODO
			// Rotate the CameraTema in Third Person mode - OX axis
		...
		{
			// TODO
			// Rotate the CameraTema in Third Person mode - OY axis
			TranslateForward(distanceToTarget);
		...
		{
			// TODO
			// Rotate the CameraTema in Third Person mode - OZ axis
			TranslateForward(distanceToTarget);
